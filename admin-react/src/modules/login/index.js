...
const Dashboard = () => {
  ...
  const handleLogin = async () => {
    try {
      ...
      Cookies.set('token', res?.data, { domain: urlHandler.getDomain(process.env.REACT_APP_PORTAL_ADDRESS) });
      ...
      Cookies.set('userName', profile?.data?.userName, { domain: urlHandler.getDomain(process.env.REACT_APP_PORTAL_ADDRESS) });
